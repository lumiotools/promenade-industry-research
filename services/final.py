...
#             # 1. In bold (**word**)
#             # 2. In technical code blocks (`word`)
#             # 3. Capitalized technical terms
#             terms = set()
...
#             # Find capitalized technical terms (2 or more consecutive capitalized words)
...
#             return {
#                 "glossary_slide": response.choices[0].message.content
#             }
...
#     # Add glossary to slides
#     presentation_slides.append(glossary_data["glossary_slide"])
    
#     # Create final markdown with glossary
#     final_markdown_path = create_marp_markdown(presentation_slides, prompt)
    
#     # Save slides to JSON and TXT
